      ...
      <div className="aui-flex-col aui-flex-center ">
        <div className="aui-flex-item-12 ">
          ...
          >
            ...
            >
              <img src="https://www.177pinche.com/public/upload/goods_images/20201127/2eefcac0423b88afb8b05caa17277270.jpg" />{' '}
              {/**/}
              <h5
            ...
            <div
              ...
              style={{ position: 'relative', padding: '3px' }}
            >
              <img src="https://www.177pinche.com/public/upload/goods_images/20210706/96c6cc95dd2194d7e4ae47792babbb54.jpeg" />{' '}
              {/**/}
              <h5
                className="aui-text-default aui-ellipsis-2 aui-font-size-12 aui-padded-t-5 aui-padded-l-5 aui-padded-r-5 aui-bg-white"
                style={{ height: '2rem', marginBottom: 0 }}
            ...
            <div
              ...
              style={{ position: 'relative', padding: '3px' }}
            >
              <img src="https://www.177pinche.com/public/upload/goods_images/20190722/3b72ee27af86e4d3d36d019c24645f4d.JPG" />{' '}
              {/**/}
              <h5
                className="aui-text-default aui-ellipsis-2 aui-font-size-12 aui-padded-t-5 aui-padded-l-5 aui-padded-r-5 aui-bg-white"
                style={{ height: '2rem', marginBottom: 0 }}
