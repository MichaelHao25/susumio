    ...
    _createClass(MiniRefreshTheme, [
      {
        ...
        value: function _initDownWrap() {
          ...
          this.downWrapHeight =
            this.downWrap.offsetHeight || DEFAULT_DOWN_HEIGHT;
      ...
      },
      {
        ...
        value: function _pullHook(downHight, downOffset) {
          ...
          if (downHight < downOffset) {
            ...
            downHight >= downOffset &&
            (!secretGarden || downHight < secretGardenOffset)
          ) {
      ...
      },
      {
        ...
        value: function _secretGardenAnimation(isInAnim) {
          var bgAnimClassAdd = isInAnim
            ? CLASS_SECRET_GARDEN_BG_IN
            : CLASS_SECRET_GARDEN_BG_OUT;
          var bgAnimClassRemove = isInAnim
            ? CLASS_SECRET_GARDEN_BG_OUT
            : CLASS_SECRET_GARDEN_BG_IN;
          var moonAnimClassAdd = isInAnim
            ? CLASS_SECRET_GARDEN_MOON_IN
            : CLASS_SECRET_GARDEN_MOON_OUT;
          var moonAnimClassRemove = isInAnim
            ? CLASS_SECRET_GARDEN_MOON_OUT
            : CLASS_SECRET_GARDEN_MOON_IN;
